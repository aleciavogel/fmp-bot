...
// Which
export const whichQuotes = z.enum(['forex', 'crypto', 'stock', 'index', 'commodity']).describe('Which type of data to retrieve quotes for');

// The format of the response. JSON or CSV. Default: json
export const datatype = z.enum(['json', 'csv']).describe('The format of the response. JSON or CSV. Default: json');

// The structure of the response. Default: hierarchy
export const structure = z.enum(['flat', 'hierarchy']).describe('The structure of the response. Default: hierarchy');

// The period of the data. Default: annual
export const period = z.enum(['annual', 'quarterly']).describe('The period of the data. Default: annual');

// The fiscal period of the data. Default: FY
export const fiscalReportPeriod = z.enum(['FY', 'Q1', 'Q2', 'Q3', 'Q4']).describe('The period of the data');

// Fiscal Quarter
export const fiscalReportQuarter = z.enum(['Q1', 'Q2', 'Q3', 'Q4']).describe('The fiscal quarter of the data');
...
export const cryptocurrency = z.string().describe('The symbol of the cryptocurrency. Example: BTCUSD');
...
export const reportingCik = z.string().describe('The CIK of the reporting company. Example: 0000320193');

// The start date of the historical data to view. Format: YYYY-MM-DD
export const from = z.string().describe('The start date of the historical data to view. Format: YYYY-MM-DD');

// The end date of the historical data to view. Format: YYYY-MM-DD
export const to = z.string().describe('The end date of the historical data to view. Format: YYYY-MM-DD');

// The maximum number of data points to return
export const limit = z.number().describe('The maximum number of data points to return. Example: 100');

// The timeframe for the historical data. Example: 1d
export const timeframe = z.enum(['1min', '5min', '15min', '30min', '1hour', '4hour']).describe('The timeframe for the historical data. Example: 4hour');

// The timeframe for the technical indicators
export const technicalIndicatorTimeframe = z.enum(['1min', '5min', '15min', '30min', '1hour', '4hour', '1day']).describe('The timeframe for the technical indicators');

// The type of technical indicator
export const technicalIndicatorType = z.enum(['sma', 'ema', 'wma', 'dema', 'tema', 'williams', 'rsi', 'adx', 'standardDeviation']).describe('The type of technical indicator');

// The period of the technical indicator. Example: 10
export const technicalIndicatorPeriod = z.number().describe('The period of the technical indicator. Example: 10');
...
export const country = z.string().describe('The target country, formatted as an ISO 3166-1 alpha-2 country code. Example: US');
...
export const marketCapMoreThan = z.number().describe('The minimum market capitalization of the stock');

// The maximum market capitalization of the stock
export const marketCapLowerThan = z.number().describe('The maximum market capitalization of the stock');
...
export const crowdfundingName = z.string().describe('The name of the company, campaign, or crowdfunding platform');

// The search query to use for the CIK look-up
export const cikSearchName = z.string().describe('The search query to use for the CIK look-up. Example: zuckerberg');

// Name of institutional manager, ticker symbol, or CUSIP number. Example: Berkshire Hathaway
export const institutionalHolderName = z.string().describe('Name of institutional manager, ticker symbol, or CUSIP number. Example: Berkshire Hathaway');
...
export const mergersAcquisitionSearchName = z.string().describe('The name of the company to search for. Example: syros');

// The name of the company to retrieve. Example: Vanguard
export const mutualFundName = z.string().describe('The name of the company to retrieve. Example: Vanguard');

// The name of the analyst to retrieve. Example: Tim Anderson
export const analystName = z.string().describe('The name of the analyst to retrieve. Example: Tim Anderson');
...
export const equityOfferingName = z.string().describe('The name of the company, offering, or exchange. Example: NJOY');

// Market state type. Example: bearish
export const marketStateType = z.enum(['bearish', 'bullish']).describe('Market state type. Example: bearish');

// Source of trending social sentiment data. Example: stocktwits
export const socialSentimentSource = z.string().describe('Source of trending social sentiment data. Example: stocktwits');

// Name of economic indicator to use
export const economicIndicatorName = z.enum([
  'GDP',
  'realGDP',
  'nominalPotentialGDP',
  'realGDPPerCapita',
